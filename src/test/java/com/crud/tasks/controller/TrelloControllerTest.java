...
class TrelloControllerTest {
    ...
    void shouldFetchEmptyTrelloBoards() throws Exception{
        ...
        mockMvc.perform(get("/v1/trello/boards").contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().is(200)) // pr isOk()
    ...
    public void shouldCreateTrelloCard() throws Exception{
        ...
        CreatedTrelloCardDto createdTrelloCardDto = new CreatedTrelloCardDto(
                ...
                "Test",
                "http://test.com",
                new Badges(2,new AttachmentByType(new Trello(2,2))));
        ...
        mockMvc.perform(post("/v1/trello/cards")
                ...
                .andExpect(jsonPath("$.badges.votes", is(2)))
                .andExpect(jsonPath("$.badges.attachmentsByType.trello.board", is(2)))
                .andExpect(jsonPath("$.badges.attachmentsByType.trello.card", is(2)));
    }
}